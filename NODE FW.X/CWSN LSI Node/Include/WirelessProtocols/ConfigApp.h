...
//----------------------------------------------------------------------------//
    ...
    //--------------------------------------------------------------------------
        ...
        /**********************************************************************/
        #define ADDITIONAL_NODE_ID_SIZE 0  //LSI - For including MyDeviceAddress
    ...
    //--------------------------------------------------------------------------
        ...
        //Transceivers buffer size
        #if defined MRF24J40
            #define MRF24J40_TX_BUF_SIZE 98
            #define MRF24J40_RX_BUF_SIZE 98
            ...
            #define MRF49XA_TX_BUF_SIZE 105
            #define MRF49XA_RX_BUF_SIZE 105
